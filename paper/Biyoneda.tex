...
\begin{definition}
  ...
  \begin{enumerate}[label=(\roman*)]
    ...
    \item natural isomorphisms
          ...
          $$\lambda_f : \id \circ f \cong f$$
          $$\rho_f : f \circ \id \cong f$$
          called the  \emph{associator} and the \emph{unitors}, satisfying the pentagon and triangle axioms.
  \end{enumerate}
\end{definition}
...
%% I dont know if we need the whole thing.
\begin{lstlisting}
...
$\mathtt{catLiftEquiv}$ witnesses $C \simeq \mathtt{catLift}(C)$ for every category $C$.
